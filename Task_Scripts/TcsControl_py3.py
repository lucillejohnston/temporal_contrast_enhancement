...
class TcsDevice:
    ...
    def enable_follow_mode(self):
        """
        Enables follow mode on the thermode.
        In follow mode, the thermode will adjust its temperature based on the baseline temperature.
        """
        self.s_port.write(bytes(b'Od'))  # Send 'Od' command to enable follow mode
        self.s_port.flushOutput()
    
    def disable_follow_mode(self):
        """
        Disables follow mode on the thermode.
        In this mode, the thermode will not adjust its temperature based on the baseline temperature.
        """
        self.s_port.write(bytes(b'A'))  # Send 'A' command to disable follow mode
        self.s_port.flushOutput()
